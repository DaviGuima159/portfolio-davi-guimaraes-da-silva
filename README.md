...
| **Batalha de Modelos & Engenharia de Prompt (XML)** | Comparação prática entre modelos de Inteligência Artificial utilizando prompts estruturados em XML para geração automatizada de aplicações web responsivas. | [Ver Projeto](./projeto-batalha-de-modelos-xml/) |
